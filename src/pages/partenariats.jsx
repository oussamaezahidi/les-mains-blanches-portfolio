  ...
  return (
    <div className="container section" style={{ marginTop: '80px' }}>
      ...
      <div className="text-center" style={{ marginBottom: '5rem' }}>
        <h2 style={{ color: 'var(--color-dark-green)', marginBottom: '1.5rem' }}>Nos Partenaires Institutionnels</h2>
      ...
      <div className="feature-panel" style={{ 
        ...
        <div className="split-grid grid" style={{ gridTemplateColumns: '1.5fr 1fr', alignItems: 'start' }}>
          ...
          <div style={{ 
            ...
            <h4 style={{ color: 'var(--color-dark-green)', marginBottom: '1.5rem', borderBottom: '2px solid var(--color-light-green)', paddingBottom: '0.5rem' }}>
              Couverture Géographique
            </h4>
