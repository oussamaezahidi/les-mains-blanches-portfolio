    ...
    <div style={{ paddingTop: '100px', backgroundColor: '#fff' }}>
      <section className="section container">
        <div className="text-center" style={{ marginBottom: '4rem' }}>
          <h2 style={{ color: 'var(--color-dark-green)', fontSize: '2.5rem', fontWeight: '800' }}>
            Nous Contacter
          </h2>
          <div
            style={{
        ...
        <div className="contact-grid">
          <div className="contact-card">
            <h3 style={{ marginBottom: '2rem', color: 'var(--color-dark-green)', fontWeight: '700' }}>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="form-group" style={{ marginBottom: '1.5rem' }}>
                <label style={{ fontWeight: '600', display: 'block', marginBottom: '8px' }}>Adresse e-mail</label>
                <input
                  type="email"
                  name="email"
